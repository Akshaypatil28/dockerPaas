...
<br><p align="center"> 
<select name="file"><option value="">Select File Name </option>
<option value="main4">main4</option> 
</select>
<select name="ext"><option value="">Select Extension </option>
...
<a href='<?php echo $links; ?>' target='_blank'><input type="button" value="output"></a><br/>
</form>
</body>
