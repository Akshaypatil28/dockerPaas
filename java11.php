...
<option value="main2" selected>main2</option> 
</select>
<select name="ext">
<option value="">Select Extension </option>
<option value=".java" selected>java </option></select>
<input type="submit" class="bnt btn-danger" value="Save" name="save"><input type="reset" class="bnt btn-danger" value="Clear"></p><br>
<p align="center">
    <a href='<?php echo $ddd; ?>' target='_blank'><input type="button" value="Compile"></a>
