...
<!-- <div style="background-color:rgb(5,154,50)">
	<h3 align="center" style="background-color:rgb(5,154,50)"><i>CODING PLATFORM<i></h3>
	<hr style="margin:0px">
</div> -->
<header>
      <div class="container">
...
<input type="submit" class="bnt btn-danger" value="Save" name="save">   <input type="reset" class="bnt btn-danger" value="Clear"></p><br>
    <p align="center">
        <a href='<?php echo $bbb; ?>' target='_blank'><input type="button" value="Compile"></a>
