...
<option value="main1" selected>main1</option> 
</select>
<select name="ext">
<option value="">Select Extension </option>
<option value=".cpp" selected>c++ </option></select>
<input type="submit" class="bnt btn-danger" value="Save" name="save">     <input type="reset" class="bnt btn-danger" value="Clear"></p><br>
    <p align="center">
        <a href='<?php echo $ccc; ?>' target='_blank'><input type="button" value="Compile"></a>
        <a href='<?php echo $links; ?>' target='_blank'><input type="button" value="Run"></a>
        <br/>
    </p>
</form>
</body>
